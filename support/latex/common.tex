...
%   linkcolor=darkblue,
%   citecolor=darkblue,
   pdftitle={(Updated) Pharo by Example},
   pdfauthor={Andrew P. Black, St\'ephane Ducasse,	Oscar Nierstrasz,
Damien Pollet},
   pdfkeywords={Pharo, Object-Oriented Programming, OOP, Smalltalk},
...
\textbf{Notes:}}{\vspace{0.3cm}\hrule\end{minipage}\end{center}}
\newenvironment{todo}{\begin{center}\begin{minipage}{8cm}
\textbf{Book Todo:}}{\end{minipage}\end{center}}

\newenvironment{important}{\begin{center}\begin{minipage}{8cm}\hrule\vspace{0.2cm}
\textbf{Important!}}{\vspace{0.3cm}\hrule\end{minipage}\end{center}}
